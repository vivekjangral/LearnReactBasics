    ...
    <div className="w-full flex gap-5 h-screen bg-zinc-900 p-20 font-['Founders_Grotesk_X-Condensed']">
      <div className="w-1/2 h-full flex flex-col justify-between ">
        <div className="heading">
          <h1 className="text-[10vw] font-semibold leading-none uppercase -mb-10">
            Eye-
          </h1>
          <h1 className="text-[10vw] font-semibold leading-none uppercase -mb-10">
            Opening
      ...
      <div className="w-1/2">
        ...
        <div className="links font-['Neue_Montreal'] mt-10">
          <a className="block font-light text-xl" href="">
            Facebook
          </a>
          <a className="block font-light text-xl" href="">
            Instagram
